...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt_client = $conn->prepare("INSERT INTO clients (client_name, subscription_status, trial_ends_at) VALUES (?, 'trial', DATE_ADD(NOW(), INTERVAL 30 DAY))");
    ...
    $stmt_user_insert = $conn->prepare("INSERT INTO usuarios (nome_completo, email, telefone, nif, nome_usuario, senha, client_id, subscription_status, trial_ends_at) VALUES (?, ?, ?, ?, ?, ?, ?, 'trial', DATE_ADD(NOW(), INTERVAL 30 DAY))");
