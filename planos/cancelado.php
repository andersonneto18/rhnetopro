...
<head>
    ...
    <title>Pagamento cancelado - <?php echo htmlspecialchars($companyName); ?></title>
...
<body>
    <div class="card">
        ...
        <p>Nenhum valor foi cobrado. Pode tentar novamente quando quiser.</p>
        <a class="button" href="index.php">Voltar aos planos</a>
    </div>
</body>
</html>
